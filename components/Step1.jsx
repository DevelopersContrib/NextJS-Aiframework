                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <div className="select-1st">
                                ...
                                />
                                <label htmlFor="styled-checkbox-1" onClick={() => handleCheckboxChange('cd1')}>
                        ...
                        <div className="col-md-4">
                            <div className="select-2nd">
                                ...
                                />
                                <label htmlFor="styled-checkbox-2" onClick={() => handleCheckboxChange('cd2')}>
                        ...
                        <div className="col-md-4">
                            <div className="select-3rd">
                                ...
                                />
                                <label htmlFor="styled-checkbox-3" onClick={() => handleCheckboxChange('cd3')}>
                        ...
                        <div className="col-md-4">
                            <div className="select-4th">
                                ...
                                <label htmlFor="styled-checkbox-4" onClick={() => handleCheckboxChange('cd4')}>
                        ...
                        <div className="col-md-4">
                            <div className="select-5th">
                                ...
                                <label htmlFor="styled-checkbox-5" onClick={() => handleCheckboxChange('cd5')}>
                        ...
                        <div className="col-md-4">
                            <div className="select-6th">
                                ...
                                <label htmlFor="styled-checkbox-6" onClick={() => handleCheckboxChange('cd6')}>
